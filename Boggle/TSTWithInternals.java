...
public class TSTWithInternals<Value> {
    private int N;       // size
    ...
    public boolean containsWithPrefix(String key) {
        Iterable<String> results = prefixMatch(key);
        return (results != null && results.iterator().hasNext());
    }
    ...
    public static void main(String[] args) {
        ...
        TSTWithInternals<Integer> st = new TSTWithInternals<Integer>();
