...
public class RandomizedQueue_Array<Item> implements Iterable<Item> {
    ...
    public RandomizedQueue_Array()  { }            // construct an empty randomized queue
    ...
    public Item dequeue() {                  // delete and return a random item
        ...
        size--;
        int randoCalrissian = StdRandom.uniform(size);
