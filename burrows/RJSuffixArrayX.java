...
public class RJSuffixArrayX {
     ...
     */
    public RJSuffixArrayX(String text) {
        N = text.length();
        text = text + '\0';
    ...
    private boolean less(int i, int j, int d) {
        ...
        /*
        for (; d < N; d++) {
            int ival = text[index[i] + d];
            int jval = text[index[j] + d];
    ...
    public static void main(String[] args) {
        //yo, I didn't write this class -- just modified the one from algs4....
    }
